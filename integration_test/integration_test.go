...
`,
	...
	godel/config/check-plugin.yml: failed to upgrade check "varcheck" legacy configuration: failed to upgrade asset configuration: varcheck-asset does not support legacy configuration with a non-empty "args" field
`,
				WantFiles: map[string]string{
					"godel/config/check-plugin.yml": `
legacy-config: true
