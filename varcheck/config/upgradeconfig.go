...
import (
	"github.com/palantir/godel-okgo-asset-varcheck/varcheck/config/internal/legacy"
	v0 "github.com/palantir/godel-okgo-asset-varcheck/varcheck/config/internal/v0"
